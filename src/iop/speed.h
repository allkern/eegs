...
// - Flash (also known as EROM, used in PSX DESR units)
...
struct ps2_speed {
    ...
    uint16_t pio_dir; // 0x1000002c
    uint16_t pio_data; // 0x1000002e
    uint32_t xfr_ctrl; // 0x10000032
    uint32_t if_ctrl; // 0x10000064
    uint32_t pio_mode; // 0x10000070
    uint32_t mwdma_mode; // 0x10000072
    uint32_t udma_mode; // 0x10000074
};
